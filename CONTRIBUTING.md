# Contributing to Mini CRM Rescue

Mini CRM Rescue is part of the Fox & Hen public tool set. Contributions should keep the project useful, inspectable, forkable, and safe to demonstrate in public.

## Good First Contributions

- Add or improve a synthetic sample scenario that demonstrates: A CRM cleanup demo for deduping leads, flagging missing fields, prioritizing follow-up, and exporting cleaner records.
